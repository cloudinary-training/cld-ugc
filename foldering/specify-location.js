...
cloudinary.uploader.upload("./assets/omakase-platter-3.jpg",
{public_id: "california/restaurant38/dishes/omakase-platter-3"})
...
cloudinary.uploader.upload("./assets/model-with-bangs.jpg",
{folder: "store77/fall-coats-2023"})
	.then(result => {console.log(result)})
	.catch(error => {console.log(error)});
